defmodule Hello.CMSTest do
  ...
  describe "pages" do
    ...
    @valid_attrs %{views: "some views ", body: "some body", title: "some title"}
    @update_attrs %{views: "some updated views", body: "some updated body", title: "some updated title"}
    @invalid_attrs %{views: nil, body: nil, title: nil}
